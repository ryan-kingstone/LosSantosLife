...
using LosSantosLife.Gamemode.Database;
...
public class Life : Script
{
    ...
    */
    ...
    private void API_onResourceStart()
    {
        ...
        #region Life initialization
        if (AllowedStart)
        {
            var lifeInstance = new LifeInstance(API);
            LifeLogging.Log("Starting the Life instance manager", LogType.Info);
        }
        #endregion
    }
